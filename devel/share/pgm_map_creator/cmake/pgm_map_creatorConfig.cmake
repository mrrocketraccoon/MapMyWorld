...
if("TRUE" STREQUAL "TRUE")
  set(pgm_map_creator_SOURCE_PREFIX /home/workspace/MapMyWorld/src/pgm_map_creator)
  set(pgm_map_creator_DEVEL_PREFIX /home/workspace/MapMyWorld/devel)
  ...
  set(pgm_map_creator_INSTALL_PREFIX /home/workspace/MapMyWorld/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'robond <haoyang@udacity.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pgm_map_creator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pgm_map_creator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/MapMyWorld/src/pgm_map_creator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pgm_map_creator_NUM_DUMMY_TARGETS)
      set(pgm_map_creator_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pgm_map_creator::wrapped-linker-option${pgm_map_creator_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pgm_map_creator_NUM_DUMMY_TARGETS "${pgm_map_creator_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pgm_map_creator::wrapped-linker-option${pgm_map_creator_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pgm_map_creator_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/workspace/MapMyWorld/devel/lib;/opt/ros/kinetic/lib)
